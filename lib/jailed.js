...
(function (root, factory) {
     ...
     * @param {Function} fCb to call upon failure
     */
    Connection.prototype.importJailedScript = function(path, sCb, fCb, options) {
        var f = function(){};
        this._importCallbacks[path] = {sCb: sCb||f, fCb: fCb||f};
        this._platformConnection.send({type: 'importJailed', url: path, options: options });
    }
     ...
     * @param {Function} fCb to call upon failure
     */
    Connection.prototype.execute = function(code, sCb, fCb, options) {
        this._executeSCb = sCb||function(){};
        this._executeFCb = fCb||function(){};
        this._platformConnection.send({type: 'execute', code: code, options: options });
    }
     ...
     */
    var Plugin = function(url, _interface, options) {
        this._path = url;
        ...
        // You have to have the application object - force it if necessary
        if ( this._options.expose.indexOf('application') ===  -1 ) {
            this._options.expose.push('application');
        }
        this._connect();
    };
     ...
     * @param {Object} options that control the security of the jail
     */
    var DynamicPlugin = function(code, _interface, options) {
        this._code = code;
        this._initialInterface = _interface||{};
        this._options = {
                        secure: true,
    ...
    Plugin.prototype._loadPlugin = function() {
        ...
        this._connection.importJailedScript(this._path, sCb, this._fCb, this._options);
    }
    ...
    DynamicPlugin.prototype._loadPlugin = function() {
        ...
        this._connection.execute(this._code, sCb, this._fCb, this._options);
    }
